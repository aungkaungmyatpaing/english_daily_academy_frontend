              ...
              {faqs.length > 0 ? (
                ...
                <div className="w-[50%] border-l-[3px] flex flex-col gap-3 border-error px-5">
                  ...
                  <p className="text-md text-base-300">
                    ...
                    Molestias blanditiis iste consectetur consequatur ratione
                    illo accusamus suscipit soluta ab nam, natus dicta nobis
                    cupiditate nostrum voluptatum repellat? Consectetur, illum
                    dolorum?
                  </p>
                </div>
              )}
